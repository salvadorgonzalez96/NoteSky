...
public class CustomEditorRender_CustomSelectionActionModeCallback
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("NotesSky.Droid.CustomControls.CustomEditorRender+CustomSelectionActionModeCallback, NotesSky.Android", CustomEditorRender_CustomSelectionActionModeCallback.class, __md_methods);
	}


	public CustomEditorRender_CustomSelectionActionModeCallback ()
	{
		super ();
		if (getClass () == CustomEditorRender_CustomSelectionActionModeCallback.class)
			mono.android.TypeManager.Activate ("NotesSky.Droid.CustomControls.CustomEditorRender+CustomSelectionActionModeCallback, NotesSky.Android", "", this, new java.lang.Object[] {  });
	}
