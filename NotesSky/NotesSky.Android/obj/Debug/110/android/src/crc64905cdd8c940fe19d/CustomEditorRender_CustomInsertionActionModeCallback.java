...
public class CustomEditorRender_CustomInsertionActionModeCallback
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("NotesSky.Droid.CustomControls.CustomEditorRender+CustomInsertionActionModeCallback, NotesSky.Android", CustomEditorRender_CustomInsertionActionModeCallback.class, __md_methods);
	}


	public CustomEditorRender_CustomInsertionActionModeCallback ()
	{
		super ();
		if (getClass () == CustomEditorRender_CustomInsertionActionModeCallback.class)
			mono.android.TypeManager.Activate ("NotesSky.Droid.CustomControls.CustomEditorRender+CustomInsertionActionModeCallback, NotesSky.Android", "", this, new java.lang.Object[] {  });
	}
